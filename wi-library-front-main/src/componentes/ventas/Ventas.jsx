                    ...
                    <div className="w-full">
                        <div className=" shadow overflow-hidden sm:rounded-lg border-b border-gray-200 ">
                            <div id="formulario" className="bg-white p-3">
                              <br></br>
                              <label  className="mr-5 pt-10 text-gray-700 text-sm font-bold mb-2" htmlFor="Cliente">Cliente</label>
                                ...
                                {/* Input */}
                                <div className="mb-4">
                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="Nombre">Buscar</label>
                                    <input
                                ...
                                <label className="block text-gray-700 text-sm font-bold mb-2 ml-6" htmlFor="Nombre">Cantidad</label>
                                    ...
                                    detallesFiltrados.map((item)=>(
                                        <ul key={item.id_libro} >
                                            <li className="px-6 py-3 border-b border-gray-200  text-left text-xs leading-4 font-medium text-gray-600 uppercase tracking-wider">
                                               { (item.stock-item.ventas)>0 && (<button className="bg-gray-600 hover:bg-gray-900 mr-10 p-2 text-white uppercase font-bold" onClick={()=>{agregarLibro(item.id_libro,item.stock-item.ventas)}}>Agregar</button>)} 
                                               { (item.stock-item.ventas) == 0 && (<label className="bg-gray-900 hover:bg-gray-900 mr-10 p-2 text-white uppercase font-bold">Sin Stock</label>)} 
